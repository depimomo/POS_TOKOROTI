		...
		<div class="col-lg-12" style="padding-left:3.5%;height:698px;margin-left:0%;width:100%">
			...
			<div class="row" style="padding:3%;padding-left:0%;padding-top:1%">
				<div class="row text-right" style="margin-left:1%;margin-right:1%;margin-bottom:1%">
					...
					<button class="btn btn-biru" style="height:37px;width:130px"> <i class="fa fa-plus" aria-hidden="true" style="margin-right:10px"></i>
					ADD BREAD </button></a>
				</div>
				...
				<div class="container-fluid">
					<table class="table table-striped" style="border:1px solid #E0E0E0" id="example">
						...
						<tr>
							...
							<td>monicadevi</td>
							<td> 
							<a href="admin_edit_bread.html">
							<button type='button' class='btn btn-warning' name='edit'><span class='glyphicon glyphicon-pencil'></span> Edit</button></a>
							<button type='button' class='btn btn-danger' name='delete' data-toggle="modal" data-target="#myModal">
						...
						<tr>
							...
							<td>monicakapan</td>
							<td> 
							<button type='button' class='btn btn-warning' name='edit'><span class='glyphicon glyphicon-pencil'></span> 
							Edit</button>
